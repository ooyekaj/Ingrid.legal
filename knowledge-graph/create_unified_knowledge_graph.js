...
class UnifiedKnowledgeGraphBuilder {
    ...
    async buildUnifiedGraph() {
        ...
        const existingEdges = this.processEdges(ccpGraph);
...
<body>
    ...
    <script>
        const graphData = ${JSON.stringify(this.unifiedGraph, null, 2)};
            ...
            style: [
                {
                    ...
                    style: {
                        ...
                        'text-outline-color': 'data(system_color)'
                    }
                },
                {
                    selector: 'edge',
