				...
				<section className="relative py-20 md:py-32 text-center overflow-hidden">
					<div className="container mx-auto px-6 relative">
						...
						<p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
							...
							deterministic rules engine with an end-to-end filing workflow. We
							transform the chaos of court rules into actionable,
					...
					<div className="container mx-auto px-6">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
							...
							<div className="feature-card rounded-2xl p-6">
								...
								<p className="text-gray-600">
									Bank-level security with attorney-client privilege protection
				...
				>
					<div className="container mx-auto px-6">
						<div className="text-center mb-16">
							...
							<p className="text-gray-600 mt-2 max-w-2xl mx-auto">
								From case intake to final filing, Ingrid streamlines your entire
								procedural workflow in three simple steps.
							</p>
						</div>
				...
				>
					<div className="container mx-auto px-6">
						<div className="text-center mb-16">
							...
							<p className="text-gray-600 mt-2 max-w-2xl mx-auto">
								See what our beta partners are saying about Ingrid's impact on
								their practice.
							</p>
						</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							<div className="bg-white rounded-2xl p-8 shadow-lg">
								...
								<p className="text-gray-600 mb-6">
									"Ingrid has transformed our motion practice. What used to take
									hours of rule-checking now happens in seconds. The accuracy is
									incredible."
								</p>
								<div className="flex items-center">
									<div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center mr-4">
										<span className="text-pink-600 font-bold text-lg">SM</span>
									</div>
									<div>
							...
							<div className="bg-white rounded-2xl p-8 shadow-lg">
								...
								<p className="text-gray-600 mb-6">
									...
									associates can now focus on substantive legal work instead of
									hunting through court rules."
								</p>
								<div className="flex items-center">
									<div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center mr-4">
				...
				>
					<div className="container mx-auto px-6">
						<div className="text-center mb-16">
							...
							<p className="text-gray-600 mt-2 max-w-2xl mx-auto">
								Get answers to common questions about Ingrid's legal technology
								platform.
							</p>
						</div>
						...
						<div className="max-w-4xl mx-auto">
							<div className="space-y-6">
								<div className="bg-gray-50 rounded-lg p-6">
									...
									<p className="text-gray-600">
										Ingrid's deterministic rules engine is 99.9% accurate. Our
										system is built on a comprehensive database of court rules
										that's continuously updated by our legal team and validated
								...
								<div className="bg-gray-50 rounded-lg p-6">
									...
									<p className="text-gray-600">
										We currently support all California state courts and federal
										courts in the Northern District of California. We're rapidly
										expanding to other California districts and planning
										nationwide coverage by Q4 2025.
									</p>
								</div>
								...
								<div className="bg-gray-50 rounded-lg p-6">
									...
									<p className="text-gray-600">
										...
										strict adherence to attorney-client privilege protection.
								...
								<div className="bg-gray-50 rounded-lg p-6">
									...
									<p className="text-gray-600">
										Ingrid offers flexible pricing based on firm size and usage.
										Our beta partners receive special pricing during the trial
										period. Full pricing will be announced at our general
										availability launch.
									</p>
								</div>
							</div>
				...
				>
					<div className="container mx-auto px-6">
						...
						<p className="text-gray-600 max-w-2xl mx-auto mb-8">
							We are launching a private beta for select litigation firms in the
							Bay Area. Join us to shape the future of procedural compliance and
